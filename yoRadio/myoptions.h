...
#define TFT_MOSI 18      // DISPLAY_MOSI_PIN
#define TFT_SCK  8       // DISPLAY_CLK_PIN
#define TFT_DC   16      // DISPLAY_DC_PIN
#define TFT_RST  17      // DISPLAY_RST_PIN
#define TFT_CS   2       // DISPLAY_CS_PIN
#define TFT_BL   15      // DISPLAY_BACKLIGHT_PIN（如固件支持背光控制）
